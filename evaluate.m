...
maskdir = 'C:\资料\2020-12-DR\AISTD\test\test_B\';
MD = dir([maskdir '/*.png']);

% result directory|结果路径
% shadowdir = 'C:\资料\2020-09-G2R\G2R-ShadowNet\ckptfs\B_100_mask6\';  
shadowdir = 'C:\资料\2020-09-G2R\G2R-ShadowNet\ckpt\B_100_mask6\';  
SD = dir([shadowdir '/*.png']);

% ground truth directory|GT路径
freedir = 'C:\资料\2020-12-DR\AISTD\test\test_C_fixed_official\'; %AISTD
FD = dir([freedir '/*.png']);
